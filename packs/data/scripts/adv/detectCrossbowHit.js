...
world.afterEvents.entityDie.subscribe((e) => {
	...
	if (
		...
		damagerProjectile.typeId != "minecraft:arrow"
	)
		return;

	const holdingItem = damager
		.getComponent("inventory")
		.container.getItem(damager.selectedSlot);
...
export function countUniqueHits(player) {
	let playerTags = player
		.getTags()
		.filter((tag) => tag.startsWith("crossbow_hit_"));
