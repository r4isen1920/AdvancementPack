...
world.afterEvents.entitySpawn.subscribe((e) => {
	...
	const blockFilter = findBlockVolume(
		Vector3.subtract(entity.location, new Vector3(1, 1, 1)),
		Vector3.add(entity.location, new Vector3(1, 1, 1)),
		entity.dimension,
		"minecraft:lightning_rod",
	);
	if (blockFilter?.typeId != "minecraft:lightning_rod") return;

	const entityFilter = entity.dimension.getEntities({
